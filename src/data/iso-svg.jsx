...
export const SvgWeed = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><SharedDefs />
    <g transform="translate(50, 100) scale(2) translate(-50, -80)">
...
export const SvgRock = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><SharedDefs />
    <g transform="translate(50, 100) scale(1.7) translate(-50, -75)">
...
// 4. Structures Assets
// ==========================================
export const SvgRoad = () => <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><Fl type="road" color="#cbd5e1" thickness={4} scale={2.0} cx={50} cy={100} /></svg>;
export const SvgWater = () => <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><Fl type="water" color="#0284c7" thickness={3} scale={2.0} cx={50} cy={100} /></svg>;
export const SvgGarden = () => <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><Fl type="garden" color="#b45309" thickness={4} scale={2.0} cx={50} cy={100} /></svg>;

export const SvgFence = () => (
  <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><SharedDefs />
    <g transform="translate(50, 100) scale(1.7) translate(-50, -75)">
      <polygon points="-20,0 20,-20 25,-18 -15,2" fill="#020617" opacity="0.3" filter="url(#soft-shadow)" />
      <g transform="translate(-15, -5)">
        <polygon points="0,0 3,-1.5 3,-15 0,-13.5" fill="#78350f" />
        <polygon points="0,0 -3,-1.5 -3,-15 0,-13.5" fill="#92400e" />
        <polygon points="0,-13.5 -3,-15 0,-16.5 3,-15" fill="#b45309" />
      </g>
      ...
      <polygon points="-16,-12 6,-23 6,-19 -16,-8" fill="#b45309" />
      <polygon points="-16,-12 -16,-10 6,-21 6,-23" fill="#fde68a" opacity="0.3" />
      <polygon points="-14,-17 8,-28 8,-24 -14,-13" fill="#b45309" />
      <polygon points="-14,-17 -14,-15 8,-26 8,-28" fill="#fde68a" opacity="0.3" />
    </g>
  </svg>
);
...
export const SvgWindmill = () => (<svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><SharedDefs /><g transform="translate(50, 100) scale(1.7) translate(-50, -75)"><ellipse cx="0" cy="0" rx="18" ry="9" fill="#020617" opacity="0.3" filter="url(#soft-shadow)" /><polygon points="0,0 -12,-6 -12,-30 0,-24" fill="#fde047" /><polygon points="0,0 12,-6 12,-30 0,-24" fill="#fef08a" /><polygon points="0,-24 -12,-30 0,-36 12,-30" fill="#ca8a04" /><path d="M 0,-28 L -18,-48 M 0,-28 L 18,-48 M 0,-28 L -18,-8 M 0,-28 L 18,-8" stroke="#f8fafc" strokeWidth="4" strokeLinecap="round" /><circle cx="0" cy="-28" r="3" fill="#d97706" /></g></svg>);

export const SvgBellTower = () => (<svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><SharedDefs /><g transform="translate(50, 100) scale(1.7) translate(-50, -75)"><ellipse cx="0" cy="0" rx="16" ry="8" fill="#020617" opacity="0.3" filter="url(#soft-shadow)" /><polygon points="0,0 -12,-6 -12,-24 0,-18" fill="#ffedd5" /><polygon points="0,0 12,-6 12,-24 0,-18" fill="#fde68a" /><polygon points="0,-18 -14,-25 0,-38 14,-25" fill="#78350f" /><polygon points="0,-18 14,-25 14,-23 0,-16" fill="#451a03" /><circle cx="0" cy="-22" r="4" fill="#fbbf24" filter="url(#glow-effect)" /><path d="M 0,-26 L 0,-18" stroke="#78350f" strokeWidth="1" /></g></svg>);

export const SvgCherryRoad = () => <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><Fl type="road" color="#fce7f3" thickness={4} scale={2.0} cx={50} cy={100} /></svg>;

export const SvgClockTower = () => (<svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><SharedDefs /><g transform="translate(50, 100) scale(1.7) translate(-50, -75)"><ellipse cx="0" cy="0" rx="16" ry="8" fill="#020617" opacity="0.3" filter="url(#soft-shadow)" /><polygon points="0,0 -10,-5 -10,-35 0,-30" fill="#fef3c7" /><polygon points="0,0 10,-5 10,-35 0,-30" fill="#fde68a" /><polygon points="0,-30 -12,-36 0,-48 12,-36" fill="#92400e" /><polygon points="0,-30 -12,-36 -12,-34 0,-28" fill="#78350f" /><circle cx="-5" cy="-20" r="5" fill="#f8fafc" /><circle cx="5" cy="-20" r="5" fill="#f8fafc" /><line x1="-5" y1="-20" x2="-5" y2="-23" stroke="#1e293b" strokeWidth="1" /><line x1="5" y1="-20" x2="6" y2="-22" stroke="#1e293b" strokeWidth="1" /></g></svg>);

export const SvgGoldStatue = () => (<svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><SharedDefs /><g transform="translate(50, 80)" filter="url(#strong-shadow)"><polygon points="0,-60 -15,-10 0,0 15,-10" fill="url(#grad-gold)" /><polygon points="0,-60 -15,-10 0,-20" fill="#fcd34d" /><polygon points="0,-60 15,-10 0,-20" fill="#b45309" /><circle cx="0" cy="-62" r="2" fill="#fef08a" filter="url(#glow-effect)" /></g></svg>);

export const SvgFestivalStage = () => (<svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><SharedDefs /><g transform="translate(50, 100) scale(1.7) translate(-50, -75)"><ellipse cx="0" cy="0" rx="24" ry="12" fill="#020617" opacity="0.3" filter="url(#soft-shadow)" /><polygon points="0,0 -20,-10 0,-20 20,-10" fill="#fef9c3" /><polygon points="0,0 -20,-10 -20,-14 0,-4" fill="#d97706" /><polygon points="0,0 20,-10 20,-14 0,-4" fill="#b45309" /><polygon points="0,-14 -22,-25 0,-30 22,-25" fill="#ef4444" /><polygon points="0,-14 -22,-25 -22,-23 0,-12" fill="#dc2626" /><circle cx="-10" cy="-20" r="2" fill="#fbbf24" filter="url(#glow-effect)" /><circle cx="10" cy="-20" r="2" fill="#fbbf24" filter="url(#glow-effect)" /><circle cx="0" cy="-25" r="2" fill="#fbbf24" filter="url(#glow-effect)" /></g></svg>);
