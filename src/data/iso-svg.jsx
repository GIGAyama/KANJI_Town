...
// 4. Structures Assets
// ==========================================
export const SvgRoad = () => <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><Fl type="road" color="#cbd5e1" thickness={4} scale={1.6} cx={50} cy={75} /></svg>;
export const SvgWater = () => <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><Fl type="water" color="#0284c7" thickness={3} scale={1.6} cx={50} cy={75} /></svg>;
export const SvgGarden = () => <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><Fl type="garden" color="#b45309" thickness={4} scale={1.6} cx={50} cy={75} /></svg>;
...
export const SvgCherryRoad = () => <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md"><Fl type="road" color="#fce7f3" thickness={4} scale={1.6} cx={50} cy={75} /></svg>;
...
export const SvgGhostBoss = () => (<svg viewBox="0 0 100 100"><SharedDefs /><g transform="translate(50,70)" filter="url(#glow-effect)"><path d="M-30,20 Q0,-40 30,20 Q15,10 0,20 Q-15,10 -30,20 Z" fill="#9333ea" opacity="0.8"/><circle cx="-10" cy="0" r="5" fill="#f8fafc"/><circle cx="10" cy="0" r="5" fill="#f8fafc"/></g></svg>);
