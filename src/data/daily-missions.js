// デイリーミッション定義 — マイ漢字タウン（大規模拡張: 25テンプレート）
// 毎日3つのランダム課題で追加報酬
...
export const MISSION_TEMPLATES = [
  ...
  { id: 'craft_5',       name: 'クラフト5回（かい）',                       desc: 'アイテムを5回（かい）クラフトする',                                         type: 'craft',     target: 5,   reward: 200, rewardExp: 500 },
  ...
  { id: 'master_3',      name: '漢字（かんじ）を3字（じ）マスター',         desc: '漢字（かんじ）を3文字（もじ）マスターする',                                 type: 'master',    target: 3,   reward: 400, rewardExp: 800 },

  // ── コイン獲得系（2種） ─────────────────
  { id: 'earn_coins_100', name: 'コイン100枚（まい）獲得（かくとく）',      desc: 'コインを100枚（まい）以上（いじょう）かせぐ',                               type: 'earn_coins', target: 100, reward: 0, rewardExp: 200 },
  { id: 'earn_coins_300', name: 'コイン300枚（まい）獲得（かくとく）',      desc: 'コインを300枚（まい）以上（いじょう）かせぐ',                               type: 'earn_coins', target: 300, reward: 0, rewardExp: 500 },
];
