 ...
 *
 * 学習ログ共通スキーマ仕様書 study.v1 §5.1.2 の参照実装（ロジック版 1.1）。
 * 全アプリで同一の動作とするため、ロジック本体をこのファイル単独で改変しないこと。
 * `study.records.v1` はアプリ間共有キーであり、リセット処理・クリーンアップの
 * 対象に含めてはならない（仕様 §1.1 / §1.2）。
 */
